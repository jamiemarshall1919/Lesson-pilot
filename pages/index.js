// align/api-ui: curriculum-first UI + Advanced options (multi-lesson + quiz)
...
export default function Home() {
  ...
  const [numLessons,   setNumLessons]   = useState(1);   // 1–5
  ...
  return (
    <>
      <Head><title>Lesson Pilot</title><link rel="icon" href="/favicon.ico"/></Head>

      <div style={{
        fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif',
        background:'#f5f5f7',minHeight:'100vh',display:'flex',justifyContent:'center',padding:'3rem 1rem'
      }}>
        <div style={{background:'#fff',padding:'2rem',borderRadius:12,boxShadow:'0 4px 20px rgba(0,0,0,0.05)',width:'100%',maxWidth:760}}>
          <h1 style={{textAlign:'center',marginBottom:'2rem',fontWeight:600,fontSize:'2rem',color:'#1c1c1e'}}>Lesson Pilot</h1>

          {/* Curriculum */}
          <label style={{display:'block',marginBottom:'1rem'}}><strong>Curriculum:</strong>
          ...
          {/* Subject */}
          <label style={{display:'block',marginBottom:'1rem'}}><strong>Subject:</strong>
          ...
          {/* Grade / Year */}
          <label style={{display:'block',marginBottom:'1rem'}}><strong>{gradeLabel}</strong>
          ...
          {/* Topic */}
          <label style={{display:'block',marginBottom:'1.5rem'}}><strong>What do you want to teach?</strong>
            <textarea rows={4} style={{width:'100%',padding:'0.75rem',borderRadius:8,border:'1px solid #ccc',marginTop:'0.5rem'}}
          ...
          {/* Messages */}
          {error&&<p style={{marginTop:'1rem',background:'#fee',color:'#a40000',padding:'0.9rem',borderRadius:8}}>{error}</p>}
          ...
          {!loading&&output&&(
            <>
              ...
              <article style={{
                background:'#fafafa',padding:'1.35rem',borderRadius:10,border:'1px solid #ddd',
                maxHeight:520,overflowY:'auto',lineHeight:1.65,fontSize:16
...
/* ---------- styles ---------- */
const selectStyle={marginTop:'0.5rem',width:'100%',padding:'0.55rem',borderRadius:8,border:'1px solid #ccc'};
const primaryButtonStyle={width:'100%',padding:'0.8rem',background:'#007aff',color:'#fff',border:'none',
  borderRadius:8,fontWeight:600,fontSize:'1rem',cursor:'pointer',transition:'opacity 0.2s'};
const secondaryButtonStyle={flex:1,padding:'0.8rem',background:'#555',color:'#fff',border:'none',
